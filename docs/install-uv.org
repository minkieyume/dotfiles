...
然后patchelf命令来修复路径问题：
#+begin_src shell
guix shell patchelf -- patchelf --set-interpreter (guix build glibc)/lib/ld-linux-x86-64.so.2 /home/minkieyume/.local/share/pipx/venvs/uv/bin/uv
guix shell patchelf -- patchelf --set-interpreter (guix build glibc)/lib/ld-linux-x86-64.so.2 /home/minkieyume/.local/share/pipx/venvs/uv/bin/uvx
#+end_src
