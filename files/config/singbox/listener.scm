...
(define (sing-box-listener file-name)
  ...
  (define %proxy-rules
    '((("rule_set" . "geosite-gfw"))
      ...
      (("ip_cidr" . #("2600:1f18::/32" "2a01:4f9::/32" "2a00:1450::/32" "2a03:2880::/32"))) ;外网IPv6
      (("domain_suffix" . #("boiledscript.com" "chn.moe" "korange.work")))
      (("domain_suffix" . #("shirakumo.org" "itch.io")))
      ...
      (("domain_suffix" . #("git.guix.gnu.org" "ci.guix.gnu.org" "lispworks.com" "nvidia.com")))
      (("domain_suffix" . #("login.tailscale.com" "control.tailscale.com")))
