...
#+begin_src scheme :noweb-ref home-service
  (simple-service 'gtk-settings-new
  		...
  		`(("gtk-3.0/settings.ini"
  		   ,(local-file "../files/config/chikoniko/gtk3.conf"))
  		  ("gtk-4.0/settings.ini"
  		   ,(local-file "../files/config/chikoniko/gtk4.conf"))))
#+end_src
...
下面的配置暂时是不需要的：
#+begin_src scheme :noweb-ref home-service
  (simple-service 'fcitx5-gtk-immodules-cache
  		home-xdg-configuration-files-service-type
  		`(("gtk-3.0/immodules.cache"
  		   ,(computed-file "immodules.cache"
  				   #~(begin
