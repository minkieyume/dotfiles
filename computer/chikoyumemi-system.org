...
#+begin_src scheme :noweb-ref service
  (simple-service 'autofs-file
  		etc-service-type
  		(list
  		 `("autofs.conf" ,(local-file "../files/config/autofs/autofs.conf"))
  		 `("autofs/auto.master" ,(local-file "../files/config/autofs/auto.master"))
  		 `("autofs/auto.nfs" ,(local-file "../files/config/autofs/auto.nfs"))))
#+end_src

#+begin_src scheme :noweb-ref service
  (simple-service 'autofs
  		shepherd-root-service-type
  		(list
  		 (shepherd-service
  		   (documentation "自动挂载服务")
  		   (provision '(autofs))
  		   (requirement '(file-systems))
  		   (start #~(make-forkexec-constructor
  			     (list #$(file-append (spec->pkg "autofs") "/sbin/automount"))))
...
#+end_src
[[file:../files/config/chikoyumemi/niri.kdl][Niri配置]]
...
(service home-pipewire-service-type
	  ...
	  (extra-content (string-append "pcm.hdmi71 {\n type hw \n card 0 \n device 3 \n channels 8 \n }"))))
#+end_src
