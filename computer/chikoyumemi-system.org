...
最后，添加环境变量：
#+begin_src scheme :noweb-ref home-environment-variable
  ("LD_LIBRARY_PATH" . "$HOME/.guix-profile/lib:/run/current-system/profile/lib:$LD_LIBRARY_PATH")
...
(simple-service 'ollama-serve
                ...
                (list (shepherd-service
                       ...
                       (start #~(make-forkexec-constructor
                                 (list #$(file-append (spec->pkg "ollama-linux-amd64") "/bin/ollama")
                                       "serve")
                                 #:environment-variables
				 (append
				  (list "OLLAMA_HOST=0.0.0.0:11434")
