...
(simple-service 'postgres-pass-file
		etc-service-type
		`(("secret/postgres/forgejo" ,(plain-file "forgejo-db-password.txt"
							   (nyapasu-ref 'forgejo-db)))))
#+end_src
    	 ...
    	 (syncthing-configuration (user "minkieyume")
  				  (config-file
  				   (syncthing-config-file
  				    ...
  				    (gui-user "minkieyume")
  				    (gui-password "$2a$10$TZcxvm7oleRcyLkl8o8v5emoGHEIXoSczLpmPKSUAEBUqzn4c6Nk.")))))
#+end_src
...
#+begin_src scheme :noweb yes :noweb-prefix no
	 ...
	 (forgejo-configuration
	   ...
	   (config
	    `((#f
               ...
               ("RUN_MODE" . "prod")
	       ("APP_SLOGAN" . "雏翼工作室的代码仓库"))
	      ("server"
	       ("DOMAIN" . "vcs.yumieko.com")
	       ("HTTP_PORT" . "3020")
	       ("ROOT_URL" . "https://vcs.yumieko.com/")
	       ("PROTOCOL" . "http")
	       ("DISABLE_SSH" . "false")
	       ("SSH_PORT" . "2222")
	       ("START_SSH_SERVER" . "true")
	       ("SSH_DOMAIN" . "vcs.yumieko.com")
	       ("APP_DATA_PATH" . "/var/lib/forgejo/data")
	       ("LFS_START_SERVER" . "true")
	       ("LFS_JWT_SECRET" . ,(nyapasu-ref 'forgejo-lfs-jwt-secret))
	       ("OFFLINE_MODE" . "true"))
              ("database"
               ("DB_TYPE" . "postgres")
               ("HOST" . "127.0.0.1:5432")
	      ...
	      ("mailer"
	       ("ENABLED" . "true")
	       ("SMTP_ADDR" . "mail.yumieko.com")
	       ("PORT" . "587")
	       ("FROM" . "\"Forgejo\"<littlewing@yumieko.com>")
	       ("USER" . "littlewing@yumieko.com")
	       ("PASSWD" . ,(nyapasu-ref 'forgejo-smtp-pass)))
	      ("security"
	       ("INSTALL_LOCK" . "true")
	       ("INTERNAL_TOKEN" . ,(nyapasu-ref 'forgejo-internal-token))
	       ("PASSWORD_HASH_ALGO" . "pbkdf2_hi"))
	      ("oauth2"
	       ("JWT_SECRET" . ,(nyapasu-ref 'forgejo-jwt-secret)))
              ("service"
